    ...
    public static void main(String [] args) {
        ...
        while (opc!=6){
            ...
            switch (opc){
                ...
                case 2:
                    int num_int = 0;
                    short num_short1 = Short.parseShort(JOptionPane.showInputDialog(null, "Ingresa el tipo de dato short:","De short a int",JOptionPane.QUESTION_MESSAGE));
                ...
                case 3:
                    long num_long = 0;
                    int num_int1 = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingresa el tipo de dato entero:","De int a long",JOptionPane.QUESTION_MESSAGE));
                ...
                case 4:
                    float num_float = 0;
                    long num_long1 = Long.parseLong(JOptionPane.showInputDialog(null, "Ingresa el tipo de dato long:","De long a float",JOptionPane.QUESTION_MESSAGE));
                ...
                case 5:
                    double num_double = 0;
                    float num_float1 = Float.parseFloat(JOptionPane.showInputDialog(null, "Ingresa el tipo de dato float:","De float a double",JOptionPane.QUESTION_MESSAGE));
